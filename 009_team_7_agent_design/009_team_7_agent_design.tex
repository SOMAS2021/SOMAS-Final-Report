...
\item  \textbf{Extraversion}: The extent to which an individual is willing and eager to socialise and interact with other individuals. An extroverted individual is more likely to occupy positions of leadership and influence. 
...
%NEED A TABLE INCLUDING BEHAVIOURAL TRAITS, HOW THEY'RE INITIALISED BY PERSONALITY, AND HOW THEY CHANGE OVER THE SIM.
...
%Below is a description of the key pieces of information stored in the agent's memory:
