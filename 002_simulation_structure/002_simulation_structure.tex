...
\begin{itemize}
    \item \textbf{\texttt{MessageType}}: Indicates the message type.
...
\end{enumerate}
Option 2 was eliminated quickly for its unreasonable premise, as it was not clear conceptually how an agent could yell only to one recipient. \newline
