...
Our implementation began with considering the structure of the system given the scenario we had identified. The key components that needed to exist included creating a tower, with Agents inside, all controlled by an overall loop that would increment based on a standard time measurement. 
