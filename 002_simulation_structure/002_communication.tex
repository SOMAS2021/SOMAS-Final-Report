...
Beyond the MVP, however, messages needed to have meaning. Because the process would be automated it was meaningless to send unstructured strings, how was an agent to understand \textquotedblleft Please only eat what you need to survive. \textquotedblright ? \newline
...
\begin{enumerate}
    \item An agent could be \textit{asking} another agent for information. \textquotedblleft How much food is on the platform when it gets to you? \textquotedblright or \textquotedblleft How much food did you take? \textquotedblright
    \item An agent could be \textit{stating} something about its state or environment. \textquotedblleft I am in critical (health) condition \textquotedblright or \textquotedblleft There is no more food left on the platform \textquotedblright
    \item An agent could be \textit{request} something from another agent. \textquotedblleft Please leave 10 food on the platform for me. \textquotedblright
    \item An agent could be \textit{responding} to another agent's request. \textquotedblleft Yes \textquotedblright or \textquotedblleft No. \textquotedblright
\end{enumerate}
